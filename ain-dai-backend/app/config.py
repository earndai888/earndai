...
class Settings(BaseSettings):
    ...
    # โดเมนสาธารณะของเซิร์ฟเวอร์ (เช่น https://earndai-production.up.railway.app)
    # ใช้สร้างลิงก์รูป QR ในการ์ด LINE — LINE ต้องโหลดรูปจาก https ได้ (เว้นว่าง = ปิดจ่ายในแชท)
    public_base_url: str = ""
